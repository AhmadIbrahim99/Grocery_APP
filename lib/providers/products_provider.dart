...
class ProductsProvider with ChangeNotifier {
  ...
  ProductModel getProductById({required String id}) =>
      _productsList.firstWhere((element) => element.id == id);

  List<ProductModel> findByCategory(String category) => _productsList
